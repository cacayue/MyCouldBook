...
exports.CloudBookListRoutingModule = void 0;
...
var CloudBookListRoutingModule = /** @class */ (function () {
    function CloudBookListRoutingModule() {
    }
    CloudBookListRoutingModule = __decorate([
        core_1.NgModule({
            imports: [router_1.RouterModule.forChild(routes)],
            exports: [router_1.RouterModule]
        })
    ], CloudBookListRoutingModule);
    return CloudBookListRoutingModule;
}());
exports.CloudBookListRoutingModule = CloudBookListRoutingModule;
