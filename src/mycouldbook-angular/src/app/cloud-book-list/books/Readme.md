...
```ts
{//	的菜单按钮
text:'Book',i18n:'Book',acl:'Pages.Book',icon:'iconfont icon-dashboard',link:'/app/main/books',sort:99},

```

请注意：以上link的值 '/app/main/books') 中的 main在是指模块名称为main.module.ts，所以在添加菜单时请注意。
...
new MenuItem('Book', 'Pages.Book', 'iconfont icon-dashboard', '/app/main/books')
...
选择以下代码段,二选一
 //包含权限验证 
 ```
{  path: 'books', component:BookComponent,data: { permission: 'Pages.Book' }  }, 
