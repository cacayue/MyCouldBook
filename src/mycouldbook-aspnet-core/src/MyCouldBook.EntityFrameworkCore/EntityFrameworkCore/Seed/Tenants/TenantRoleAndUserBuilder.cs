...
namespace MyCouldBook.EntityFrameworkCore.Seed.Tenants
{
    public class TenantRoleAndUserBuilder
    {
        private readonly MyCouldBookDbContext _context;
        private readonly int _tenantId;

        public TenantRoleAndUserBuilder(MyCouldBookDbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        private void CreateRolesAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new MyCouldBookAuthorizationProvider())
