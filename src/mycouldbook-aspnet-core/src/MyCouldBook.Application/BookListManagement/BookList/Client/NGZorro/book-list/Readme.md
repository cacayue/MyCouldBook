...
```ts
{//	的菜单按钮
text:'BookList',i18n:'BookList',acl:'Pages.BookList',icon:'iconfont icon-dashboard',link:'/app/main/booklist',sort:99},

```

请注意：以上link的值 '/app/main/booklist') 中的 main在是指模块名称为main.module.ts，所以在添加菜单时请注意。
...
new MenuItem('BookList', 'Pages.BookList', 'iconfont icon-dashboard', '/app/main/booklist')
...
选择以下代码段,二选一
 //包含权限验证 
 ```
{  path: 'booklist', component:BookListComponent,data: { permission: 'Pages.BookList' }  }, 
