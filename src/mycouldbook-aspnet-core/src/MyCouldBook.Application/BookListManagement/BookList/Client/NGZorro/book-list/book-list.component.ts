...
@Component({
    ...
    export class  BookListComponent extends PagedListingComponentBase<BookListListDto>
    implements OnInit {
    ...
    */
    ...
    this._bookListService.getPaged(
    this.filterText,
    request.sorting,
   ...
   // abp.message.error('已经开发完成测试通过！！！！');
    this._bookListService.getToExcelFile().subscribe(result => {
